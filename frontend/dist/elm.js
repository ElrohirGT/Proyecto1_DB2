...
var $author$project$Main$ReportMsg = function (a) {
	return {$: 'ReportMsg', a: a};
};
...
var $author$project$Main$Trace = function (a) {
	return {$: 'Trace', a: a};
};
var $author$project$Main$TraceMsg = function (a) {
	return {$: 'TraceMsg', a: a};
};
...
var $author$project$Pages$Trace$init = _Utils_Tuple2(
	A3($author$project$Pages$Trace$Model, '5', false, $elm$core$Maybe$Nothing),
	$elm$core$Platform$Cmd$none);
...
var $author$project$Routing$Report = {$: 'Report'};
var $author$project$Routing$Statistics = {$: 'Statistics'};
var $author$project$Routing$Trace = {$: 'Trace'};
...
var $author$project$Routing$routeParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2($elm$url$Url$Parser$map, $author$project$Routing$Home, $elm$url$Url$Parser$top),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Routing$Trace,
			$elm$url$Url$Parser$s('trace')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Routing$Statistics,
			$elm$url$Url$Parser$s('stats')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Routing$Report,
			$elm$url$Url$Parser$s('report'))
		]));
var $author$project$Routing$parseUrl = function (url) {
	var parsedUrl = A2($elm$url$Url$Parser$parse, $author$project$Routing$routeParser, url);
	if (parsedUrl.$ === 'Just') {
		var a = parsedUrl.a;
		return a;
	} else {
...
var $author$project$Main$init = F3(
	function (flags, url, navKey) {
		var route = $author$project$Routing$parseUrl(url);
		var _v0 = function () {
			switch (route.$) {
				case 'Home':
					return A3(
				...
				case 'NotFound':
					return A3(
						...
						$elm$core$Platform$Cmd$map($author$project$Main$NotFoundMsg),
						$author$project$Pages$NotFound$init);
				case 'Report':
					return A3(
						$elm$core$Tuple$mapBoth,
						$author$project$Main$Report,
						$elm$core$Platform$Cmd$map($author$project$Main$ReportMsg),
						$author$project$Pages$Report$init);
				case 'Statistics':
					return A3(
						$elm$core$Tuple$mapBoth,
						$author$project$Main$Stats,
						$elm$core$Platform$Cmd$map($author$project$Main$StatsMsg),
						$author$project$Pages$Stats$init);
				default:
					return A3(
						$elm$core$Tuple$mapBoth,
						$author$project$Main$Trace,
						$elm$core$Platform$Cmd$map($author$project$Main$TraceMsg),
						$author$project$Pages$Trace$init);
			}
		}();
		var innerModel = _v0.a;
		var initialEffect = _v0.b;
		return _Utils_Tuple2(
			A2($author$project$Main$Model, navKey, innerModel),
			initialEffect);
	});
	...
	switch (_v0.$) {
		case 'Home':
			...
			return A2(
				...
				$author$project$Pages$Home$subscriptions(inner));
		case 'NotFound':
			var inner = _v0.a;
			return A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$NotFoundMsg,
				$author$project$Pages$NotFound$subscriptions(inner));
		case 'Report':
			var inner = _v0.a;
			return A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$ReportMsg,
				$author$project$Pages$Report$subscriptions(inner));
		case 'Stats':
			var inner = _v0.a;
			return A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$StatsMsg,
				$author$project$Pages$Stats$subscriptions(inner));
		default:
			var inner = _v0.a;
			return A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$TraceMsg,
				$author$project$Pages$Trace$subscriptions(inner));
	}
};
...
var $author$project$Pages$Report$update = F2(
	function (msg, model) {
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	});
					...
					$author$project$Api$Endpoint$request(
						{
							...
							timeout: $elm$core$Maybe$Nothing,
							tracker: $elm$core$Maybe$Nothing,
							url: $author$project$Api$Endpoint$getHistory(model.productId)
						}));
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'HomeMsg':
				...
				if (_v2.$ === 'Home') {
					...
					var _v3 = A3(
						...
						$author$project$Main$Home,
						$elm$core$Platform$Cmd$map($author$project$Main$HomeMsg),
						A2($author$project$Pages$Home$update, innerMsg, innerModel));
					var newModel = _v3.a;
					var effect = _v3.b;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'NotFoundMsg':
				...
				if (_v4.$ === 'NotFound') {
					...
					var _v5 = A3(
						...
						$author$project$Main$NotFound,
						$elm$core$Platform$Cmd$map($author$project$Main$NotFoundMsg),
						A2($author$project$Pages$NotFound$update, innerMsg, innerModel));
					var newModel = _v5.a;
					var effect = _v5.b;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'ReportMsg':
				...
				if (_v6.$ === 'Report') {
					...
					var _v7 = A3(
						...
						$author$project$Main$Report,
						$elm$core$Platform$Cmd$map($author$project$Main$ReportMsg),
						A2($author$project$Pages$Report$update, innerMsg, innerModel));
					var newModel = _v7.a;
					var effect = _v7.b;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'StatsMsg':
				...
				if (_v8.$ === 'Stats') {
					...
					var _v9 = A3(
						...
						$author$project$Main$Stats,
						$elm$core$Platform$Cmd$map($author$project$Main$StatsMsg),
						A2($author$project$Pages$Stats$update, innerMsg, innerModel));
					var newModel = _v9.a;
					var effect = _v9.b;
					return _Utils_Tuple2(
						_Utils_update(
			...
			default:
				var innerMsg = msg.a;
				var _v10 = model.model;
				if (_v10.$ === 'Trace') {
					var innerModel = _v10.a;
					var _v11 = A3(
						$elm$core$Tuple$mapBoth,
						$author$project$Main$Trace,
						$elm$core$Platform$Cmd$map($author$project$Main$TraceMsg),
						A2($author$project$Pages$Trace$update, innerMsg, innerModel));
					var newModel = _v11.a;
					var effect = _v11.b;
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Utils$mapMsg = F2(
	function (mapper, doc) {
		return {
			body: A2(
				$elm$core$List$map,
...
var $author$project$Utils$toUnstyled = function (doc) {
	return {
		body: A2($elm$core$List$map, $rtfeldman$elm_css$Html$Styled$toUnstyled, doc.body),
		title: doc.title
	};
};
...
var $author$project$Theme$colors = {accent: '#8f9044', background: '#352f3d', error: '#cf1500', secondary: '#fc8020', warning: '#f8a523'};
...
var $author$project$Theme$btnStyles = _List_fromArray(
	[
		...
		$rtfeldman$elm_css$Css$hex($author$project$Theme$colors.accent))
	]);
...
var $author$project$Theme$divBackgroundStyles = _List_fromArray(
	[
		...
		$rtfeldman$elm_css$Css$backgroundColor(
		$rtfeldman$elm_css$Css$hex($author$project$Theme$colors.background)),
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							$author$project$Theme$divBackgroundStyles,
							_List_fromArray(
								[
							...
							[
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Css$color(
										$rtfeldman$elm_css$Css$hex($author$project$Theme$colors.secondary))
									]))
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('¡Bienvenido al Inicio!')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							...
							[
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Theme$btnStyles)
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Trazabilidad')
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$a,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Estadísticas')
									]))
							]))
					]))
			]),
...
var $author$project$Pages$Report$view = function (model) {
	return {
		body: _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('In Report!')
					]))
			]),
		title: 'Report!'
	};
...
var $author$project$Routing$goToHome = $rtfeldman$elm_css$Html$Styled$Attributes$href('/');
		...
		body: function () {
			var header = _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('¡Bienvenido al Trazador de Productos!')
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$value(model.productId),
									$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Pages$Trace$ProductIdChanged),
									$rtfeldman$elm_css$Html$Styled$Attributes$type_('number'),
									$rtfeldman$elm_css$Html$Styled$Attributes$placeholder('ID del producto:')
								]),
							_List_Nil),
							A2(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Pages$Trace$SearchClicked),
									$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Theme$btnStyles)
								]),
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('Buscar')
								]))
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$a,
					_List_fromArray(
						[
							$author$project$Routing$goToHome,
							$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Theme$btnStyles)
						]),
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Regresar a Inicio')
						]))
				]);
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$color(
											$rtfeldman$elm_css$Css$hex($author$project$Theme$colors.warning))
										]))
								]),
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('Cargando...')
								]))
						]);
				} else {
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$rtfeldman$elm_css$Html$Styled$text('Los proveedores son:')
													])),
												A2(
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$rtfeldman$elm_css$Css$color(
																$rtfeldman$elm_css$Css$hex($author$project$Theme$colors.error)),
												...
												_List_fromArray(
													[
														...
														A2(
															...
															' ',
															_List_fromArray(
																['No product with ID:', model.productId, 'exists!'])))
													]))
											])) : _Utils_ap(
										header,
										_List_fromArray(
...
var $author$project$Main$view = function (model) {
	var styledDoc = function () {
		var _v0 = model.model;
		switch (_v0.$) {
			case 'Home':
				var inner = _v0.a;
				return A2(
					$author$project$Utils$mapMsg,
					$author$project$Main$HomeMsg,
					$author$project$Pages$Home$view(inner));
			case 'NotFound':
				var inner = _v0.a;
				return A2(
					$author$project$Utils$mapMsg,
					$author$project$Main$NotFoundMsg,
					$author$project$Pages$NotFound$view(inner));
			case 'Report':
				var inner = _v0.a;
				return A2(
					$author$project$Utils$mapMsg,
					$author$project$Main$ReportMsg,
					$author$project$Pages$Report$view(inner));
			case 'Stats':
				var inner = _v0.a;
				return A2(
					$author$project$Utils$mapMsg,
					$author$project$Main$StatsMsg,
					$author$project$Pages$Stats$view(inner));
			default:
				var inner = _v0.a;
				return A2(
					$author$project$Utils$mapMsg,
					$author$project$Main$TraceMsg,
					$author$project$Pages$Trace$view(inner));
		}
	}();
	return $author$project$Utils$toUnstyled(styledDoc);
};
